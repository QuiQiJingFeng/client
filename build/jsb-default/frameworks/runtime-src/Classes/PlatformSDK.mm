...
{
    std::string jsdata = "{ \"value\" :" + json_params + "}";
    JSONManager manager = JSONManager();
    manager.parseValueMapFromJSON(jsdata);
    auto map = manager.getDataMap();
    auto param_array = map["value"].asValueVector();
